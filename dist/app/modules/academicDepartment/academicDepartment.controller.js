...
const createDepartment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const academicDepartment = __rest(req.body, []);
    const result = yield academicDepartment_service_1.AcademicDepartmentService.createDepartmentToDB(academicDepartment);
...
const updateDepartment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicDepartment_service_1.AcademicDepartmentService.updateDepartmentToDB(id, academicDepartment);
    (0, sendResponse_1.default)(res, {
        statuscode: http_status_1.default.OK,
        success: true,
        message: 'Department Create Successful!',
...
const getDepartments = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const paginationOptions = (0, pick_1.default)(req.query, academicDepartment_constant_1.academicDepartmentSearchableFields);
    const result = yield academicDepartment_service_1.AcademicDepartmentService.getDepartmentsFromDB(filters, paginationOptions);
    (0, sendResponse_1.default)(res, {
        statuscode: http_status_1.default.OK,
        success: true,
