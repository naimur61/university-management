...
const getAllAdminFromDB = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
...
const deleteAdminFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!admin_model_1.Admin) {
            throw new ApiError_1.ApiError(http_status_1.default.BAD_REQUEST, 'Admin Deleted failed!');
        }
        result = admin;
    }
    catch (error) {
...
const updateAdminToDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const ifExits = yield admin_model_1.Admin.findOne({ id });
    if (!ifExits) {
