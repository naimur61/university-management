...
const createSemesterToDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (academicSemester_interface_1.academicSemesterTitleCodeMapper[payload.title] !== payload.code) {
...
const getSemestersFromDB = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
...
const getSingleSemesterFromBD = (id) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateSemesterToDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (payload.code &&
        payload.title &&
        academicSemester_interface_1.academicSemesterTitleCodeMapper[payload.title] !== payload.code) {
        throw new ApiError_1.ApiError(http_status_1.default.BAD_REQUEST, 'Invalid semester code!');
    }
