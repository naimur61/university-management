...
const createStudentToDB = (student, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!newStudent.length) {
            throw new ApiError_1.ApiError(http_status_1.default.BAD_REQUEST, 'Student create failed!');
        }
...
const getUserFromDB = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
